...
export const iconAltText: { [__key in StatusType]: string } = {
...
export const statusLabel: { [_key in StatusType]: string } = {
...
export const statusDefinitionsDeps: { [_key in StatusType]: string } = {
...
export const statusDefinitionsRepos: { [_key in StatusType]: string } = {
...
export const statusDefinitionsReposSummary: { [_key in StatusType]: string } = {
...
export const statusDefinitionsHelpGuide: { [_key in StatusType]: string } = {
