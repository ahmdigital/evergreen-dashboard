...
// Creates each invidial row
	export default function Row(props: {rank: number, row: any, subRows: {internal: any[], external: any[], user: any[], final: boolean}}) {
	...
	return (
		<>
			<TableRow className={rank == 0 ? Styles.red : rank == 1 ? Styles.orange : rank == 2 ? Styles.green : Styles.plain}>
				<TableCell>
					<IconButton
				...
				<TableCell className={classes.tableCell} align="right">{semVerToString(row.version)}</TableCell>
