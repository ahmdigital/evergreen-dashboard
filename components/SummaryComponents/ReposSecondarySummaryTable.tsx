      ...
      <Table sx={{ width: '100%', tableLayout: 'fixed' }}>
        <Box sx={{ maxHeight: '160px', paddingLeft: '2px' }}>
          <TableRow>
            ...
            <TableCell className={styles.totalsCellStyle}></TableCell>
          </TableRow>
        </Box>
        <Box
          sx={{
              ...
              <div key={i.id + ' containingDiv'}>
                <TableRow
                  ...
                  sx={{
                    ...
                    width: '100%',
                    ...(filterTerm.mustHaveDependency == i.id && {
                      background: 'var(--colour-table-selected)',
                    }),
                  }}
                  onClick={() =>
                    setFilterTerm({
                      ...filterTerm,
                      mustHaveDependency:
                        filterTerm.mustHaveDependency == i.id ? -1 : i.id,
                    })
                  }
                >
                  <TableCell className={styles.tableCellStyle1}>
                    <div className={styles.textContainer}>{i.name}</div>
                  </TableCell>
                  <TableCell className={styles.tableCellStyle2}>
                    <div className={styles.countContainer}>{i.count}</div>
                  </TableCell>
                </TableRow>
              </div>
            );
