					...
					<div className={styles.btnsContainer}>
						...
						>
							<Button
								...
								sx={{
									...
									borderRadius:
										"var(--main-section-border-radius)",
									"&:hover": {
										backgroundColor:
											"var(--colour-black-hover)",
									},
								}}
								onClick={callRefresh}
							>
						...
						<span className={styles.lastUpdated}>
							...
							{props.auxData?.crawlStart
								? dayjs(
										parseInt(props.auxData?.crawlStart)
								  ).fromNow()
								: "N/A"}
						</span>
					</div>
				...
				>
					<Grid xs={12} sm={12} md={6} lg={4}>
						...
						>
							...
							>
								<h3 className={styles.overallTitleStyle}>
									Overall
								</h3>
								...
								<h3 className={styles.overallCentredTitleStyle}>
									{props.rankArray.green}/{totalRepos}{" "}
